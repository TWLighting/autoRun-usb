...
--
ALTER TABLE `autorun_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=32765;
--
...
--
ALTER TABLE `bank_card_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=85;
--
...
--
ALTER TABLE `transaction_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=29958;
--
...
--
ALTER TABLE `usb_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=74579;
--
-- 使用資料表 AUTO_INCREMENT `usb_key`
--
ALTER TABLE `usb_key`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=296;
--
