...
CREATE TABLE `autorun_job` (
  ...
  `usb_index` int(11) DEFAULT NULL COMMENT 'USB設備Port的index，最大255',
  `usb_submit_index` int(11) DEFAULT NULL COMMENT 'USB設備Submit的index，最大255',
...
CREATE TABLE `usb_job` (
  ...
  `usb_device_hashcode` varchar(32) NOT NULL COMMENT '设备hashcode',
  `port` int(11) NOT NULL COMMENT 'usb_device port',
...
CREATE TABLE `usb_key` (
  ...
  `usb_port_id` varchar(11) DEFAULT NULL COMMENT 'usb_port 流水序號',
...
CREATE TABLE `usb_port` (
  ...
  `autorun_id` int(11) NOT NULL DEFAULT '0' COMMENT 'autorun設備ID(autorun.id)',
  `autorun_status` varchar(8) NOT NULL DEFAULT '0' COMMENT 'autorun設備狀態(connect/free)',
...
ALTER TABLE `usb_key`
  ...
  ADD UNIQUE KEY `usb_port_id` (`usb_port_id`),
  ADD KEY `account_id` (`account_id`);
...
--
ALTER TABLE `autorun_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=354685;
--
...
--
ALTER TABLE `bank_card_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=78;
--
...
--
ALTER TABLE `transaction_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=40149;
--
-- 使用資料表 AUTO_INCREMENT `usb_device`
--
ALTER TABLE `usb_device`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=62;
--
-- 使用資料表 AUTO_INCREMENT `usb_job`
--
ALTER TABLE `usb_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=131127;
--
-- 使用資料表 AUTO_INCREMENT `usb_key`
--
ALTER TABLE `usb_key`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=274;
--
-- 使用資料表 AUTO_INCREMENT `usb_port`
--
ALTER TABLE `usb_port`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=625;
