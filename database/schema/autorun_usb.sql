...
CREATE TABLE `account` (
  ...
  `telegram_chatid_trans` varchar(20) DEFAULT NULL COMMENT '交易 通知',
...
CREATE TABLE `bank_card_info` (
  ...
  `ukey_pwd` varchar(30) NOT NULL COMMENT 'U盾密碼',
  `pay_pwd` varchar(30) NOT NULL COMMENT '支付密碼',
  `login_account` varchar(32) DEFAULT NULL COMMENT '登入账号(建设银行需要)',
  `balance` double(12,2) NOT NULL DEFAULT '0.00' COMMENT '餘額',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '0:disable, 1:enable , -1:error',
  `notify_enable` tinyint(4) NOT NULL DEFAULT '1' COMMENT '入账通知(开/关)',
  `login_server_id` int(11) NOT NULL DEFAULT '1' COMMENT '登入伺服器主键',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '創建時間',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='銀行卡資訊';
...
('device_version', '20190712'),
('ftp_link', 'package-r.ti58wieb@34.92.227.108-/isys'),
('initial_version', '20190722'),
('monitor_version', '20190707'),
('temp_ubox_index', '60'),
('testing_base_failed', '1'),
('testing_base_notreport', '10'),
('testing_base_processing', '10'),
('testing_base_success', '10'),
('testing_base_timeout', '10'),
('testing_base_wait', '100'),
('testing_notreport_sec', '30'),
('usb_network_gate', 'eveusb-dev_4.2.0-armv7l.deb');
...
CREATE TABLE `login_server` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL COMMENT '登入伺服器名称',
  `total_used` int(11) NOT NULL DEFAULT '0' COMMENT '使用的银行卡数量',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='登入伺服器';
...
CREATE TABLE `news_msg` (
  ...
  `deleted_account` varchar(30) DEFAULT NULL,
...
CREATE TABLE `temp_device` (
  ...
  `burn_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '防止硬体重复烧录同样hashcode，-1: 作废, 0: 未烧录, 1:已烧录',
  `test_status` smallint(6) NOT NULL DEFAULT '0' COMMENT '测试阶段0: 未开始 1: 开始测试 2~4: 其它 5: 测试完成',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE `temp_ubox` (
  `id` int(11) NOT NULL,
  `usb_uid` varchar(100) NOT NULL COMMENT 'usb_uid',
  `burn_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '用来防止硬体重复烧录同样UID，-1: 作废, 0: 未烧录, 1:已烧录',
  `print_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '贴纸列印状态 0 未列印, 1:已列印',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `transaction_info` (
  ...
  `trans_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '交易時間',
...
CREATE TABLE `usb_port` (
  ...
  `vid` varchar(16) DEFAULT NULL COMMENT '判断是否为特殊U盾',
...
-- 資料表索引 `temp_ubox`
--
ALTER TABLE `temp_ubox`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `usb_uid` (`usb_uid`);
...
ALTER TABLE `usb_job`
  ...
  ADD KEY `callback_info` (`callback_info`);
...
--
ALTER TABLE `autorun_device`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=14;
--
-- 使用資料表 AUTO_INCREMENT `autorun_job`
--
ALTER TABLE `autorun_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=73823;
--
...
--
ALTER TABLE `bank_card_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=90;
--
...
--
-- 使用資料表 AUTO_INCREMENT `login_server`
--
ALTER TABLE `login_server`
...
--
-- 使用資料表 AUTO_INCREMENT `temp_ubox`
--
ALTER TABLE `temp_ubox`
...
--
ALTER TABLE `transaction_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=22421;
--
-- 使用資料表 AUTO_INCREMENT `usb_device`
--
ALTER TABLE `usb_device`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=72;
--
-- 使用資料表 AUTO_INCREMENT `usb_job`
--
ALTER TABLE `usb_job`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=40893;
--
-- 使用資料表 AUTO_INCREMENT `usb_key`
--
ALTER TABLE `usb_key`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=300;
--
-- 使用資料表 AUTO_INCREMENT `usb_port`
--
ALTER TABLE `usb_port`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水序號', AUTO_INCREMENT=769;
